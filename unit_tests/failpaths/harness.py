...
class Harness:
    ...
    def __init__(self, rows=None, panel=None, dialog=None, *, verbose=False):
        ...
        self.suppress_extension = False
        self.extension_vanishes = False
        self.no_confirm_button = False
        self.no_cancel_button = False
        self.confirm_sticks = False
        self.commit_on_stick = False
        self.click_fault: dict = {}
        self.grab_fault: dict = {}
        self.park_fault: dict = {}
        self.focus_fault: dict = {}
        self.rows_fault: dict = {}
        self.locked = False
        self.elevated = True
        ...
        self.net_sales_extra = 0
        self.price_never_takes = False
